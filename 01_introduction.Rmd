...
```{r 01-introduction, eval = TRUE, echo = FALSE}
...
Datasets can also be bundled into packages. Here we load the `drat` library to allow us to install data packages, such as: 
[covdata](https://kjhealy.github.io/covdata) and [nycdogs](https://kjhealy.github.io/nycdogs).
